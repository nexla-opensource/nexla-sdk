...
class TestDestinationsIntegration:
        ...
        try:
            ...
            try:
                ...
                updated_destination = client.destinations.update(
                    created_destination.id, update_data
                )
                ...
                expanded_destination = client.destinations.get(
                    created_destination.id, expand=True
                )
                assertions.assert_destination_response(expanded_destination)

            except Exception as e:
                pytest.skip(
                    f"Destination CRUD test requires valid data credentials and dataset IDs: {e}"
                )
    ...
    def test_destination_activate_pause_operations(self, client):
        ...
        try:
            ...
            pytest.skip(
                f"Activate/pause operations failed (may require specific permissions): {e}"
            )
    ...
    def test_destination_copy_operation(self, client, assertions):
        ...
        try:
            ...
            copied_destination = client.destinations.copy(
                source_destination.id, copy_options
            )
            ...
            pytest.skip(
                f"Copy operation failed (may require specific permissions): {e}"
            )
        finally:
