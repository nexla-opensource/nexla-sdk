...
class TestLookupsIntegration:
        ...
        try:
            ...
            if created_lookup:
                try:
                    ...
                    print(
                        f"Warning: Failed to clean up test lookup {created_lookup.id}: {e}"
                    )
    ...
    def test_lookup_entry_operations(self, client, test_lookup_data):
        ...
        try:
            ...
            multiple_entries = client.lookups.get_entries(
                created_lookup.id, ["001", "002"]
            )
            ...
            remaining_entries = client.lookups.get_entries(
                created_lookup.id, ["001", "002", "003"]
            )
