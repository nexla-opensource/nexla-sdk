...
from nexla_sdk.models.attribute_transforms.requests import AttributeTransformCreate, AttributeTransformUpdate
...
class TestAttributeTransformsResource:
    def test_list_public_get_crud(self, client, mock_http_client):
        ...
        mock_http_client.clear_responses()
        mock_http_client.add_response("/attribute_transforms/22", {"id": 22, "name": "at2"})
        upd = client.attribute_transforms.update(22, AttributeTransformUpdate(name="at2"))
        assert upd.name == "at2"
