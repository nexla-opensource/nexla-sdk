...
class TestAsyncTasksResource:
    def test_list_types_create_get_result_download_ack_and_filters(
        ...
        mock_http_client.add_response(
            "/async_tasks/explain_arguments/BulkDeleteNotifications", {"args": []}
        )
        ...
        payload = AsyncTaskCreate(
            type="BulkDeleteNotifications", arguments={"ids": [1, 2]}
        )
        ...
        mock_http_client.clear_responses()
        mock_http_client.add_response(
            "/async_tasks/of_type/BulkDeleteNotifications", [{"id": 5}]
        )
        ...
        mock_http_client.clear_responses()
        mock_http_client.add_response(
            "/async_tasks/5/download_link", {"url": "https://url"}
        )
